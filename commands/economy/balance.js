    ...
    async execute(interaction) {
        ...
        try {
            ...
            const embed = new EmbedBuilder()
                ...
                .addFields(
                    { name: '🪙 Portefeuille', value: `${economy.coins || 0}`, inline: true },
                    { name: '🏦 Banque', value: `${economy.bank || 0}`, inline: true },
                    { name: '💎 Total', value: `${(economy.coins || 0) + (economy.bank || 0)}`, inline: true },
                    { name: '📊 Niveau', value: `${levels.level || 1}`, inline: true },
                    { name: '⭐ XP', value: `${levels.xp || 0}`, inline: true },
                    { name: '💬 Messages', value: `${levels.messages_sent || 0}`, inline: true }
                )
            ...
            await interaction.reply({ content: 'Une erreur est survenue lors de la récupération du solde.', ephemeral: true });
        }
    },
};